...
def main():
    ...
    st.markdown('Find more: [Source code](https://github.com/xiaoyuxie-vico/diamond_app), [Streamlit tutorials](https://www.youtube.com/watch?v=ZZ4B0QUHuNc&list=PLtqF5YXg7GLmCvTswG32NqQypOuYkPRUE)')
